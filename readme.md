...
The final classification logic is trained using the provided `model_generation.ipynb` (Task 4) notebook. To maximize efficiency on standard hardware, this project avoids fine-tuning the massive MERT transformer directly and instead uses a fast **downstream classification** approach:
